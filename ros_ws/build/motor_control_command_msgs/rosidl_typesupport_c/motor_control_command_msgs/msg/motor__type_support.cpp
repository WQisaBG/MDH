...
static const _Motor_type_support_symbol_names_t _Motor_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, motor_control_command_msgs, msg, Motor)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, motor_control_command_msgs, msg, Motor)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, motor_control_command_msgs, msg, Motor)() {
  return &::motor_control_command_msgs::msg::rosidl_typesupport_c::Motor_message_type_support_handle;
}
